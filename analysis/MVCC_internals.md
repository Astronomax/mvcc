...
<img src="./chain_schedule_mapping.svg" width="90%">
...
<img src="./read_gaps.svg" width="90%">
...
**(1)** В каждой из цепочек соответствующая `stmt->add_story` перемещается в конец "prepared" отрезка.
  <img src="./in_progress-to-prepared.svg" width="90%">
...
<img src="./prepare_del_story_is_null.svg" width="90%">
